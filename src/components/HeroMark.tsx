// The hero's copy of the mark. Renders the same animated rings as the shared #fx-mark symbol,
// just inline rather than via <use> (kept separate in case the hero copy ever needs its own tweaks).
